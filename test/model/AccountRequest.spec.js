...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlYourMoneyApi.AccountRequest();
  });
  ...
  describe('AccountRequest', function() {
    it('should create an instance of AccountRequest', function() {
      ...
      //var instane = new ControlYourMoneyApi.AccountRequest();
      //expect(instance).to.be.a(ControlYourMoneyApi.AccountRequest);
    });
