...
let apiInstance = new MasterMyMoneyApi.AccountApi();
let body = new MasterMyMoneyApi.AccountRequest(); // AccountRequest | 
...
let opts = { 
  'body': new MasterMyMoneyApi.PatchedAccountRequest() // PatchedAccountRequest | 
