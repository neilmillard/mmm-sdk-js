# ControlYourMoneyApi.CategorygroupApi
...
let apiInstance = new ControlYourMoneyApi.CategorygroupApi();
let body = new ControlYourMoneyApi.CategoryGroupRequest(); // CategoryGroupRequest | 
...
let opts = { 
  'body': new ControlYourMoneyApi.PatchedCategoryGroupRequest() // PatchedCategoryGroupRequest | 
